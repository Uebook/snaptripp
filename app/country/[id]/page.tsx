  ...
  japan: {
    ...
    cards: [
      { 
        ...
        title: 'About', 
        desc: 'An archipelago of over 6,000 islands, Japan\'s topography ranges from snow-capped peaks to tropical beaches, defined by deep spiritual roots.' 
      },
      { 
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        desc: 'Efficiency meets elegance. Navigate with ease using the Shinkansen, indulge in world-class culinary delights, and find peace in Zen gardens.' 
      },
      { 
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        desc: 'Spring for Sakura blossoms and Autumn for fiery maple leaves are peak seasons. Winter offers world-class skiing in Hokkaido.' 
      }
    ],
    emergency: {
      police: '110',
      ambulance: '119',
      embassy: 'Contact your local embassy or consulate for specific assistance.'
    },
    connectivity: [
    ...
    experience: {
      ...
      desc: 'Experience the mindful preparation of matcha and the profound hospitality of Japanese culture.',
      img: '/images/explore_japan.png'
    },
    cities: [
...
export default function CountryPage() {
  ...
  const data = COUNTRY_DATA[countryId] || { ...COUNTRY_DATA.japan, name: id.charAt(0).toUpperCase() + id.slice(1) }
          ...
          <div id="logistics" className={styles.twoColGrid}>
            <div className={styles.infoCol}>
              ...
              <div className={styles.colItems}>
                {data.connectivity.map((item: any, i: number) => (
            ...
            <div id="culture" className={styles.infoCol}>
              ...
              <div className={styles.colItems}>
                {data.etiquette.map((item: any, i: number) => (
                  <div key={i} className={styles.colItem}>
                    <div className={styles.colDot}></div>
                    <div>
                      <h5>{item.title}</h5>
