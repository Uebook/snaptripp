...
VALUES 
('Greece', 'Europe', 'Greece is famous for its iconic blue domes, ancient history, and stunning Aegean sunsets.', 'Santorini', 'Oia Village, Santorini', '/images/hero_greece_oia.webp', '/images/hero_greece_oia.webp'),
('Italy', 'Europe', 'Italy is known for its historic art, culinary masterpieces, and the dramatic Amalfi Coast.', 'Positano', 'Amalfi Coast, Italy', '/images/card_italy.webp', '/images/card_italy.webp'),
('Spain', 'Region', 'Spain is famous for its islands, beach holidays, surfing, diving and yachting.', 'Madrid', 'Plaza Mayor, Madrid', '/images/card_madrid.webp', '/images/hero_seoul_night.webp'),
('UAE', 'Middle East', 'UAE offers a blend of futuristic skyscrapers, luxury shopping, and desert adventures.', 'Dubai', 'Museum of the Future, Dubai', '/images/card_uae.webp', '/images/hero_uae_museum.webp'),
('USA', 'North America', 'USA features diverse landscapes from bustling New York streets to the Grand Canyon.', 'New York', 'Times Square, New York', '/images/card_usa.webp', '/images/card_usa.webp'),
('Canada', 'North America', 'Canada is renowned for its vast wilderness, stunning lakes, and friendly multicultural cities.', 'Banff', 'Moraine Lake, Banff', '/images/card_canada.webp', '/images/card_canada.webp'),
('Thailand', 'Asia', 'Thailand is a land of tropical beaches, ornate temples, and vibrant street life.', 'Phuket', 'Maya Bay, Phi Phi Islands', '/images/card_thailand.webp', '/images/card_thailand.webp'),
('Ireland', 'Europe', 'Ireland is known for its lush green landscapes, historic castles, and vibrant culture.', 'Cliffs of Moher', 'Cliffs of Moher, County Clare', '/images/why_mountains.webp', '/images/why_mountains.webp')
                      ...
                      {form.image_url ? (
                        ...
                        <div className={styles.uploadOptions}>
                          <input
                            type="text"
                            name="image_url"
                            placeholder="Paste image URL (e.g. /images/card_italy.webp)"
                            className={styles.input}
