...
// Replace any occurrence of the old keys
content = content.replace(oldAnon, newAnon);
content = content.replace(oldService, newService);

// Also replace truncated versions in case they were partially written previously
const truncatedService = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoic2VydmljZV9yb2xlIiwiaXNzIjoic3VwYWJhc2UtZGVtbyIsImlhdCI6MTY0MTc2OTIwMCwiZXhwIjoxNzk5NTM1NjA';
content = content.replace(truncatedService, newService);

fs.writeFileSync(file, content, 'utf8');
console.log('Successfully updated keys in kong.yml');
